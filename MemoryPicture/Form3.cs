...
namespace MemoryPicture
{
    public partial class Form3 : Form
    {
        ...
        public Form3(String name, int l)
        {
            level = l;
        ...
        private void StartGame(bool u1, bool u2, bool u3)
        {
        ...
        private void EGame()
        {
            ...
            {
                EndGame endGame = new EndGame(GamerUser, pointTrue, "User2", pointuser2 , "User3",pointuser3 , TimeQ , pointFalse,level);
        ...
        private void button1_Click_3(object sender, EventArgs e)
        {
            ...
            if (user1) { user2 = true; user1 = false; user3 = false; }
            else
            {
                if (user2) { user2 = false; user1 = false; user3 = true; }
                else if (user3) { user1 = true; user2 = false; user3 = false; }
            }
